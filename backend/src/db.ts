...
import { migration018 } from './db/migrations/018_proactive_triggers_and_cooldowns';
import { migration019 } from './db/migrations/019_family_health_and_timeline';
...
export function initDb() {
  ...
  runMigrations(db, [migration001, migration002, migration003, migration004, migration005, migration006, migration007, migration008, migration009, migration010, migration011, migration012, migration013, migration014, migration015, migration016, migration017, migration018, migration019], dbPath);
